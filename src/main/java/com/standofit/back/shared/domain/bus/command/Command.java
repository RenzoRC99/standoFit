 ...
 *
 * A Command represents an intention to change state. Unlike Queries,
 * Commands are write operations that modify the domain model.
 *
 * Each command should be a specific, focused action like:
