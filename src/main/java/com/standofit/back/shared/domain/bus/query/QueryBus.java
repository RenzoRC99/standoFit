 ...
 *
 * <p>The QueryBus is responsible for dispatching queries to their appropriate handlers. It acts as
 * a central coordinator that routes queries to the correct QueryHandler.
 *
 * <p>Implementation note: The QueryBus should be implemented as a singleton Spring bean that all
 * controllers can inject to execute queries.
 *
 * <p>Example usage:
 *
 * <pre>
