...
public class SessionJpaEntity {
    ...
    public SessionJpaEntity(UUID id, UUID dayId, String status, String notes, Instant createdAt, Instant updatedAt) {
        this.id = id;
        this.dayId = dayId;
        this.status = status;
        this.notes = notes;
    ...
    public List<ExerciseLogJpaEntity> getLogs() { return logs; }
    public void setLogs(List<ExerciseLogJpaEntity> logs) { this.logs = logs; }
