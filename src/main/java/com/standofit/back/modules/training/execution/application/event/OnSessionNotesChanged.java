...
@Component
public class OnSessionNotesChanged implements DomainEventHandler<SessionNotesChanged> {

  private final SessionRepository repository;
  private final SessionReadViewUpdater readViewUpdater;

  public OnSessionNotesChanged(
  ...
  @Override
  public Class<SessionNotesChanged> eventType() {
    return SessionNotesChanged.class;
  }

  @Override
  @Transactional
  public void handle(SessionNotesChanged event) {
