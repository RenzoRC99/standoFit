...
import com.standofit.back.training.execution.domain.entity.ExerciseLogMother;
...
class SessionTest {
  ...
  class ManageLogs {
    ...
    void shouldFailWhenRemovingNonExistentLog() {
      ...
      assertThrows(
          SessionDomainException.class, () -> session.removeLog(nonExistentLogId));
    }
  }
  ...
  class UpdateLogs {
    ...
    void shouldUpdateLogSets() {
      ...
      Session updated =
          session.updateLogSets(log.getId(), new com.standofit.back.modules.training.execution.domain.vo.ExerciseLogSets(5));
    ...
    void shouldUpdateLogReps() {
      ...
      Session updated =
          session.updateLogReps(log.getId(), new com.standofit.back.modules.training.execution.domain.vo.ExerciseLogReps(12));
    ...
    void shouldUpdateLogWeight() {
      ...
      Session updated =
          session.updateLogWeight(log.getId(), new com.standofit.back.modules.training.execution.domain.vo.ExerciseLogWeight(60));
  ...
  class ManageNotes {
    ...
    void shouldChangeSessionNotes() {
      ...
      Session updated = session.changeNotes(new com.standofit.back.modules.training.execution.domain.vo.WorkoutSessionNotes("Updated notes"));
    ...
    void shouldNotChangeNotesOnFinishedSession() {
      ...
      assertThrows(
          ...
          () -> session.changeNotes(new com.standofit.back.modules.training.execution.domain.vo.WorkoutSessionNotes("Notes")));
    }
  }
}
