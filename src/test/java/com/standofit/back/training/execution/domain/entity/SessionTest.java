...
class SessionTest {
    ...
    void should_finish_session() {
        Session session = Session.create(new SessionId(UUID.randomUUID()), new SessionDayId(UUID.randomUUID()));
    ...
    void should_not_finish_already_finished() {
        Session session = Session.create(new SessionId(UUID.randomUUID()), new SessionDayId(UUID.randomUUID())).finish();
    ...
    void should_not_cancel_already_cancelled() {
        Session session = Session.create(new SessionId(UUID.randomUUID()), new SessionDayId(UUID.randomUUID())).cancel();
